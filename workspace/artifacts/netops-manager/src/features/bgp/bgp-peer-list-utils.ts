/**
 * Frontend mirror of api-server bgp-peer-display-normalizer.ts — keep both files in sync.
 * Run: node tools/bgp-peer-dedupe-selftest.mjs
 */
...
/** @deprecated Use dedupeBgpPeersForDisplay — alias kept for existing imports */
export function dedupeDiscoveryBgpPeers<T extends BgpPeerMergeLike>(peers: T[]): T[] {
  return dedupeBgpPeersForDisplay(peers);
}
