...
export const env = {
  ...
  bgpAnnouncementPreviewEnabled: parseBoolean(process.env["BGP_ANNOUNCEMENT_PREVIEW_ENABLED"], true),
  bgpAnnouncementApprovalEnabled: parseBoolean(process.env["BGP_ANNOUNCEMENT_APPROVAL_ENABLED"], true),
  bgpAnnouncementDryRunEnabled: parseBoolean(process.env["BGP_ANNOUNCEMENT_DRY_RUN_ENABLED"], true),
  bgpAnnouncementExecutionEnabled: parseBoolean(process.env["BGP_ANNOUNCEMENT_EXECUTION_ENABLED"], false),
  bgpAnnouncementRequireApproval: parseBoolean(process.env["BGP_ANNOUNCEMENT_REQUIRE_APPROVAL"], true),
  bgpAnnouncementRequirePostcheck: parseBoolean(process.env["BGP_ANNOUNCEMENT_REQUIRE_POSTCHECK"], true),
  bgpAnnouncementRequireLock: parseBoolean(process.env["BGP_ANNOUNCEMENT_REQUIRE_LOCK"], true),
  bgpAnnouncementRequireMaintenanceWindow: parseBoolean(process.env["BGP_ANNOUNCEMENT_REQUIRE_MAINTENANCE_WINDOW"], false),
  bgpAnnouncementRealExecutionProvider: process.env["BGP_ANNOUNCEMENT_REAL_EXECUTION_PROVIDER"]?.trim() || "disabled",
  bgpAnnouncementRollbackEnabled: parseBoolean(process.env["BGP_ANNOUNCEMENT_ROLLBACK_ENABLED"], false),
  bgpAnnouncementRollbackDryRunEnabled: parseBoolean(process.env["BGP_ANNOUNCEMENT_ROLLBACK_DRY_RUN_ENABLED"], true),
  bgpAnnouncementRollbackRequireApproval: parseBoolean(process.env["BGP_ANNOUNCEMENT_ROLLBACK_REQUIRE_APPROVAL"], true),
  bgpAnnouncementTimelapseEnabled: parseBoolean(process.env["BGP_ANNOUNCEMENT_TIMELAPSE_ENABLED"], true),
