...
ALTER TABLE devices
ADD COLUMN IF NOT EXISTS compliance_profile_name text DEFAULT NULL;

-- Create index for faster lookups
CREATE INDEX IF NOT EXISTS idx_devices_compliance_profile ON devices(compliance_profile_name);
