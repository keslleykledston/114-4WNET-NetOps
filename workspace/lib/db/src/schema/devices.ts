...
import { connectorGroupsTable, connectorsTable } from "./connectors.js";
...
export const devicesTable = pgTable("devices", {
  ...
  connectorGroupId: integer("connector_group_id").references(() => connectorGroupsTable.id, { onDelete: "set null" }),
